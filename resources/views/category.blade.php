 ...
 <div class="p-4 sm:ml-64">
    ...
    <form id="formPost">
        <div class="mb-5">
            ...
            <input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Fantasy" required />
        </div>
        <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 hidden" role="alert" id="dangerName">
        </div>
...
<div class="mt-6 p-4 sm:ml-64">
    <h2 class="text-lg font-medium text-gray-900">List Kategori</h2>
      ...
      <div class="relative p-4 w-full max-w-md max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow">
              ...
              <form class="p-4 md:p-5" id="formEdit">
                <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 hidden" role="alert" id="dangerNameAlert">
                </div>
                <div class="p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 hidden" role="alert" id="successNameAlert">
                </div>
